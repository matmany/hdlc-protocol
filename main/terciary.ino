...
void loop()
{
    FrameSec1.addressSec2 = 0b00011100;
    FrameSec1.dataSec2 = 0b11000011;
    ...
    if (recebendoDados)
    {
        ...
        if (frameRecebido.flagFim == frameRecebido.flagInicioFim)
        {
            ...
            if (FrameSec1.addressSec2 == frameRecebido.address)
            {
            ...
            else
            {
                ...
                Serial.println(FrameSec1.addressSec2, BIN);
            }
...
void respondeDados()
{
    ...
    frameResposta.dataPrim = 0b10000000;
